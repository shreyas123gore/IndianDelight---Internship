            ...
            <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        ...
                        $_SESSION['order'] = "<div class='success text-center' style='color:#2ed573; padding-top:2%; font-weight:bold; font-size:20px;'>Food Ordered Successfully</div>";
                        header('location:'.SITEURL);
                    }
                    else
                    {
                        //Failed to Save Order
                        $_SESSION['order'] = "<div class='error text-center' style='color:red; padding-top:2%;'>Failed to Order Food</div>";
                        header('location:'.SITEURL);
                    }
